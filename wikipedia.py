...
player1_image = pygame.image.load('image/icon.png')
player2_image = pygame.image.load('image/n.png')
ball_image = pygame.image.load('image/k.png')

background_image = pygame.image.load('image/icon.png')
background_image = pygame.transform.scale(
    background_image, (WIDTH, HEIGHT)
)

vignette_image = pygame.image.load('image/n.png')
